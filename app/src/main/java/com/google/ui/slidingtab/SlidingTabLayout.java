...
package com.google.ui.slidingtab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        final MainFragmentPagerAdapter adapter = (MainFragmentPagerAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabIconView != null) {
                tabIconView.setImageDrawable(ContextCompat.getDrawable(getContext(), adapter.getDrawableId(i)));
            }
